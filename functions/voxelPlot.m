function voxelPlot(mat,xvec,yvec,zvec,varargin)
...
hp2 = patch('CData', IMAGE_3D_DATA.voxel_patch_CData(voxel_face_num,:),'Faces', M_faces, 'Vertices', M_vertices, 'EdgeColor', ...
    'yellow','FaceColor', 'flat');  

%'XData',xvec,'YData',yvec,'ZData',zvec,
% set the tranparency
